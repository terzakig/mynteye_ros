 ...
 public:
  ...
  void onInit() override {
    ...
    if (private_nh_.getParamCached("s1030_mesh_file", mesh_file)) {
      mesh_msg_.mesh_resource = "package://mynteye_ros/mesh/"+mesh_file;
    } else {
  ...
  bool getInfo(
      mynteye_ros::GetInfo::Request &req,     // NOLINT
      mynteye_ros::GetInfo::Response &res) {  // NOLINT
    using Request = mynteye_ros::GetInfo::Request;
    switch (req.key) {
